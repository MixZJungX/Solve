        ...
        case 'get_settings':
            ...
            jsonResponse([
                ...
                'data' => [
                    ...
                    'has_zp_checker_key' => !empty(DB::getSetting('zp_checker_key')),
                    'zp_checker_masked_key' => maskString(DB::getSetting('zp_checker_key', '')),
                    'has_zp_getcookie_key' => !empty(DB::getSetting('zp_getcookie_key')),
                    'zp_getcookie_masked_key' => maskString(DB::getSetting('zp_getcookie_key', '')),
